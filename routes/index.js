...
router.get('/', function (req, res) { 
    res.render('index', { title: 'Language App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'Language App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'Language App Login', user : req.user }); 
}); 
